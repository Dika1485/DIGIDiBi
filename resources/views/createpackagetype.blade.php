...
<head>
    ...
    <title>DIGIDiBi - Create Package Type</title>
...
<!--                                </a>-->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"> Create Package Type</h1>
                    <p class="mb-4">Here is a page to create a package type of laundry.</p>
                    
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Create Package Type</h6>
                        </div>
                        <form action="/dashboard/packagetype/create" method="post">
                        @csrf
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control form-control-user"
                                                ...
                                                placeholder="Enter package name..." name="name" required></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="form-control form-control-user"
                                                id="setrika" aria-describedby="emailHelp" name="isironing"></td>
                                        </tr>
                                        <tr>
